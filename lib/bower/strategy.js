...
BowerStrategy.prototype._install = function(type, destPath) {
  var deps;
  if (type === '*') {
...
BowerStrategy.prototype._pack = function(name, version, cb) {
  var sep = '-v';
...
BowerStrategy.prototype._packAll = function(srcList, curInst) {
  var self = this;
  var sep = '-v';
...
BowerStrategy.prototype.install = function() {
  if (this.mode === 'production') {
    this._install('dependencies', this.bowerComponentsPath);
  } else {
    this._install('*', this.bowerComponentsPath);
  }
};

BowerStrategy.prototype.pack = function(target) {
  var self = this;
  var sep = '-v';
